...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.abhiai.abhiai_backend.assistant.AssistantException.class)
    public ResponseEntity<ApiError> handleAssistant(com.abhiai.abhiai_backend.assistant.AssistantException exception, WebRequest request) {
